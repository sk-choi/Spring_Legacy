...
<!-- ------------------------------------------------------------- -->        
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach var = "v" items = "${MY_KEY_BLIST}">
                                    <tr>
                                    	<td>${v.bseq}</td>
                                    	<td><a href = "/Myboard?bseq=${v.bseq}&gubun=T001">${v.title}</a></td>
                                    	<td>${v.regid}</td>
                                    	<td>${v.regdate}</td>
                                    </tr>
                                    </c:forEach>
                                ...
                                <br>
								<%
								String pagingHtmlStr = (String)request.getAttribute("MY_KEY_PAGING_HTML");
								out.println(pagingHtmlStr);
								%>
