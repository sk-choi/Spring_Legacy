...
<table class="datatable-table">
    <tbody>
        ...
        <tr>
            <th>제목</th>
            <td><input type = "text" name = "title" size = "60" value = "${MY_KEY_BVO.title}"></td>
        ...
        <tr>
            <th>내용</th>
            <td><input type = "text" name = "contents" size = "60" rows = "5" value = "${MY_KEY_BVO.contents}"></td>
        </tr>
    </tbody>
...
<c:otherwise><c:forEach var = "rvo" items = "${MY_KEY_RLIST}">
